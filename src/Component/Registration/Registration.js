...
const Registration = () => {
    const { handleNameChange, handleEmailChange, handlePasswordChange, handleRegistration, err, signInUsingGoogle } = useAuth();
            ...
            <div className="flex min-h-screen bg-white">
                <div className="md:w-1/2 max-w-lg mx-auto px-4 py-5 shadow-none">
                    ...
                    <form onSubmit={handleRegistration} className="p-0">
                        ...
                        <div className="mt-10">
                            <input onClick={handleRegistration} type="submit" value="Sign up with email" className="py-2 border-indigo-800 border-2 transition-all duration-500 text-indigo-800  w-full rounded hover:bg-blue-600 hover:text-white text-lg font-semibold" />
                        </div>
                    </form>
                    <div>
